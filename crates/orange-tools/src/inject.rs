...
/// The helper, as assembly. See `java/OrangeRegistry.java` for what it does.
const HELPER_SOURCE: &str = include_str!("../java/OrangeRegistry.j");

/// The helper's own name, which is ours and so is never retargeted.
pub(crate) const HELPER_CLASS: &str = "OrangeRegistry";
pub(crate) const HELPER_ENTRY: &str = "OrangeRegistry.class";
...
/// Kept in step with `java/OrangeRegistry.java` by a test.
pub(crate) const HELPER_FAILURE: &str = "orange-registry: could not apply the entry list: ";
...
/// [`helper_class`].
const PLACEHOLDER_REGISTRY: &str = "orange/placeholder/Registry";
const PLACEHOLDER_KIND: &str = "orange/placeholder/Kind";
const PLACEHOLDER_GRANT: &str = "orange/placeholder/Grant";
const PLACEHOLDER_REGISTER: &str = "register";
const PLACEHOLDER_REGISTER_DESCRIPTOR: &str =
    "(Ljava/util/UUID;Ljava/lang/String;Lorange/placeholder/Kind;Ljava/lang/String;Z)V";
