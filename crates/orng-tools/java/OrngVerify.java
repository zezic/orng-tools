...
// Authoring source for OrngVerify.j, which is what the crate actually uses.
//
...
//
//   javac --release 17 -d <tmp> OrngVerify.java
//   krak2 dis --out OrngVerify.j <tmp>/OrngVerify.class
//
...
public final class OrngVerify {
    public static void main(String[] args) throws Throwable {
        ClassLoader loader = OrngVerify.class.getClassLoader();
