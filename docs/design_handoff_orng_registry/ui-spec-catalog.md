# Orange Catalog - UI requirements (design round 2)
...
**Orange Catalog** is a public, curated repository of devices, modulators and Grid modules
contributed by the community. Orange Registry can install from it directly, so a user gets
